...
mod tests {
    ...
    #[test]
    fn ultra_is_default_and_targets_250ms_sender_lead() {
    ...
    fn fallback_is_bounded() {
        assert_eq!(LatencyProfile::Ultra.fallback(), LatencyProfile::Low);
        assert_eq!(LatencyProfile::Low.fallback(), LatencyProfile::Stable);
        assert_eq!(LatencyProfile::Stable.fallback(), LatencyProfile::Stable);
    }
